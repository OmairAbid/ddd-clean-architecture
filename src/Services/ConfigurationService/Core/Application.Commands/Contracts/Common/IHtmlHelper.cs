...
public interface IHtmlHelper
{
    ...
    /// <summary>
    /// Removes link from string. This is implemented to avoid link creation.
    /// The email clients add anchor tag by default for example. www.google.com become <a href="www.google.coms"/>
    /// </summary>
    /// <param name="html"></param>
    /// <returns></returns>
