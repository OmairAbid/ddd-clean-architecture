...
public class ServicePlan
{
    ...
    public List<ServicePlanDetail> ServicePlanDetail { get; set; }
    ...
    public List<ServicePlanDetail> ServicePlanDetailAttributes { get; set; }
    ...
    public ServicePlan()
    {
        ServicePlanDetail = new List<ServicePlanDetail>();
    }
