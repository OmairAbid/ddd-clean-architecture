...
{
    // This is the extension method. The first parameter takes the "this" modifier and specifies the
    // type for which the method is defined.
    ...
    /// <summary> converting string to specified Enum e.g status.ToEnum<DocumentStatus>() </summary>
    /// <typeparam name="T">Enumeration Type</typeparam> <param name="enumString">value that needs
    /// to converted</param> <returns>Enumeration</returns>
    ...
    /// <summary> Break a list of items into chunks of a specific size var list = new List<int> { 1,
    /// 2, 3, 4, 5, 6, 7 }; var chunks = list.Chunk(3); returns { { 1, 2, 3 }, { 4, 5, 6 }, { 7 } }
    /// </summary> <typeparam name="T"></typeparam> <param name="list"></param> <param
    /// name="chunkSize"></param> <returns></returns>
